...
public class MamDeviceRunEvent implements java.io.Serializable {
	...
	public MamDeviceRunEvent() {
	}

	public MamDeviceRunEvent(Integer devId, String busId, Double latitude, Double longitude, Date eventTime, Date eventSend, Date eventWriteTime, 
